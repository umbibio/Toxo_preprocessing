...
#readRDS(file = "~/work/ToxoplasmaGondii/ToxoR/output/sme_fits_pheno.RData")
...
write.xlsx(sep_rep, '../toxo_table_batch_corrected_logCPM_expression_edgeR_DEGs_ap2_targs_phenotype_correlations_sme.xlsx')
